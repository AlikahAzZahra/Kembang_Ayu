      ...
      <div className="service-face">
        <div className="our-service10">
          <span className="our-service-txt-container1">
            ...
            <b className="service2">Service</b>
          </span>
        </div>
...
`}</li>
        ...
        <div className="group-parent2">
          ...
          <img className="desain-tanpa-judul21" alt="" src="/imagef.png" />
        </div>
      </div>
      <div className="service-face1">
        ...
        <div className="group-parent3">
          ...
          <img className="desain-tanpa-judul21" alt="" src="/imagef2.png" />
        </div>
      </div>
...
Tighten Facial Skin`}</li>
        ...
        <div className="group-parent4">
          ...
          <img className="desain-tanpa-judul21" alt="" src="/imagef3.png" />
        </div>
      </div>
      <div className="footer1">
        ...
        <div className="group-parent5">
          ...
          <div className="about-service-contact-us-our-c-group">
            ...
            <div className="our-service-wrapper3">
              <div className="our-service-wrapper3">
                <b className="our-service12">Company</b>
              </div>
            </div>
            <div className="our-service-wrapper3">
              <div className="our-service-wrapper3">
          ...
          <div className="spa-treatment-hair-treatment-n-group">
            ...
            <div className="our-service-wrapper5">
              <div className="our-service15">
                <b className="our-service12">Service</b>
              </div>
            </div>
          </div>
          <div className="green-house-boutique-indonesia-group">
            ...
            <div className="our-service-wrapper6">
              <div className="our-service17">
                <b className="our-service12">Our Center</b>
              </div>
            </div>
          </div>
        </div>
